                            ...
                            <div class="col-lg">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h5 class="mb-4"><?= $this->session->user_data('email'); ?></h5>
                                    </div>
                                    ...
                                    <form class="user" method="post" action="<?= base_url('auth/changepassword') ?>">
                                        ...
                                        <div class="form-group">
                                            <input type="password2" class="form-control form-control-user" id="password2" name="password2" placeholder="Repeat password ...">
